...
# Subtract only a wedge from the original exterior lower-right corner.
# The interior x=152 edge stays vertical and exactly where it was.
# No stroke displacement, shear, or change to the arch or ascender.
old_segment='V318 H152 V174'
new_segment='V250 L160 318 H152 V174'
...
for name,color in [('ivory',IVORY),('gold',GOLD),('ink',INK)]:
    (OUT/f'eh-corner-cut-{name}.svg').write_text(svg(place(monogram,0,0,1,color),421,405,'ElevenHouse — eh со скосом нижней правой части h'))

...
export function FinaleFooter() {
  return <footer className="eh-journey__footer eh-finale-footer">
    <span className="eh-finale-footer__copyright">Рабочее пространство астролога.<br />От первой записи до следующей встречи.<br />© {new Date().getFullYear()} ElevenHouse · Макет новой главной страницы</span>
    ...
    <nav className="eh-finale-footer__documents" aria-label="Юридические документы">
      ...
      <span>Реквизиты — после подтверждения юрлица.</span>
    </nav>
  </footer>
}

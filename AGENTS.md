# 11housemarketing: независимая копия

Рабочий проект: `/Users/anastasiavolkova/Documents/ChatGPT/11housemarketing`.
GitHub: `VV-organization/11housemarketing`.
Локальный адрес: `http://127.0.0.1:5174` (`npm run dev`).

Все дальнейшие правки делать только в этой копии. Оригинал
`/Users/anastasiavolkova/Documents/ChatGPT/11хаус` и репозиторий
`avvolkova13/11house` не менять. Git, зависимости и файлы копии независимы.
Приведённые ниже правила locked Hero сохраняют силу.
